...
import { AddHomeworkManagementAc, AddHomeworkSubjectMappingAc, HomeworkMailMapping, HomeworkMessageMapping } from './homework.model';
...
export class HomeworkComponent implements OnInit {
  ...
  dateOfHomework: Date = new Date();
  studentHomeworks: any[] = [];
  studentId: number;
  constructor(private homeworkService: HomeworkService, private loaderService: LoaderService,
  ...
  isMessageSend(option: any[]): string {
    if (option) {
