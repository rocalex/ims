...
let InstituteManagementService = class InstituteManagementService {
    constructor(http) {
        this.http = http;
        this.InstituteManagementUrl = 'api/institutemanagement';
    }
