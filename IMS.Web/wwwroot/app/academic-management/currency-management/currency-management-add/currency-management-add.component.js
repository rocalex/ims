...
let AddCurrencyManagementComponent = class AddCurrencyManagementComponent {
    ...
    addInstituteCurrency(addCurrency) {
...
AddCurrencyManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.AddCurrencyManagementComponent = AddCurrencyManagementComponent;
//# sourceMappingURL=currency-management-add.component.js.map