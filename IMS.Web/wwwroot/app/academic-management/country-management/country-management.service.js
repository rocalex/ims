...
let CountryManagementService = class CountryManagementService {
    constructor(http) {
        this.http = http;
        this.CountryManagementUrl = 'api/institutecountrystatecity/country';
    }
    addInstituteCountry(country) {
    ...
    updaInstituteCountry(country) {
        return this.http.put(this.CountryManagementUrl, country);
    }
};
CountryManagementService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], CountryManagementService);
exports.CountryManagementService = CountryManagementService;
//# sourceMappingURL=country-management.service.js.map