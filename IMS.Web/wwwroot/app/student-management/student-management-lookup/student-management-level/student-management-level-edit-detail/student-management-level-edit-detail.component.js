...
let EditAndDetailLevelManagementComponent = class EditAndDetailLevelManagementComponent {
    ...
    updateInstituteLevel(updateLevel) {
        this.loaderService.toggleLoader(true);
        var updateData = {
...
EditAndDetailLevelManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.EditAndDetailLevelManagementComponent = EditAndDetailLevelManagementComponent;
//# sourceMappingURL=student-management-level-edit-detail.component.js.map