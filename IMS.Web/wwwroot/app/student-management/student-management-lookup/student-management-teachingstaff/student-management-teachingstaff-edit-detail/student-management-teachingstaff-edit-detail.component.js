...
let EditAndDetailTeachingStaffManagementComponent = class EditAndDetailTeachingStaffManagementComponent {
    constructor(teachingStaffManagementService, loaderService, router, snackBar) {
        this.teachingStaffManagementService = teachingStaffManagementService;
    ...
    updateInstituteTeachingStaff(updateTeachingStaff) {
        this.loaderService.toggleLoader(true);
        var updateData = {
...
EditAndDetailTeachingStaffManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
        templateUrl: 'student-management-teachingstaff-edit-detail.html'
    }),
    __metadata("design:paramtypes", [student_management_teachingstaff_service_1.TeachingStaffManagementService, loader_service_1.LoaderService,
        router_1.Router, snackbar_service_1.SnackbarService])
], EditAndDetailTeachingStaffManagementComponent);
exports.EditAndDetailTeachingStaffManagementComponent = EditAndDetailTeachingStaffManagementComponent;
//# sourceMappingURL=student-management-teachingstaff-edit-detail.component.js.map