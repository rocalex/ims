...
let EditAndDetailActivityStatusManagementComponent = class EditAndDetailActivityStatusManagementComponent {
    constructor(activitystatusManagementService, loaderService, router, snackBar) {
        this.activitystatusManagementService = activitystatusManagementService;
    ...
    updateInstituteActivityStatus(updateActivityStatus) {
        this.loaderService.toggleLoader(true);
        var updateData = {
...
EditAndDetailActivityStatusManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
        templateUrl: 'student-management-activitystatus-edit-detail.html'
    }),
    __metadata("design:paramtypes", [student_management_activitystatus_service_1.ActivityStatusManagementService, loader_service_1.LoaderService,
        router_1.Router, snackbar_service_1.SnackbarService])
], EditAndDetailActivityStatusManagementComponent);
exports.EditAndDetailActivityStatusManagementComponent = EditAndDetailActivityStatusManagementComponent;
//# sourceMappingURL=student-management-activitystatus-edit-detail.component.js.map