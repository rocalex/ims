...
let SectionManagementService = class SectionManagementService {
    constructor(http) {
        this.http = http;
        this.SectionManagementUrl = 'api/sectionmanagement';
    }
    addInstituteSection(section) {
