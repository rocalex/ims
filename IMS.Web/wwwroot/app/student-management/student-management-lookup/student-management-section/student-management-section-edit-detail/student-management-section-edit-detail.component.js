...
let EditAndDetailSectionManagementComponent = class EditAndDetailSectionManagementComponent {
    constructor(sectionManagementService, loaderService, router, snackBar) {
    ...
    updateInstituteSection(updateSection) {
        this.loaderService.toggleLoader(true);
        var updateData = {
...
EditAndDetailSectionManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.EditAndDetailSectionManagementComponent = EditAndDetailSectionManagementComponent;
//# sourceMappingURL=student-management-section-edit-detail.component.js.map