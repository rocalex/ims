...
let EditAndDetailOccupationManagementComponent = class EditAndDetailOccupationManagementComponent {
    constructor(occupationManagementService, loaderService, router, snackBar) {
    ...
    updateInstituteOccupation(updateOccupation) {
        this.loaderService.toggleLoader(true);
        var updateData = {
...
EditAndDetailOccupationManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.EditAndDetailOccupationManagementComponent = EditAndDetailOccupationManagementComponent;
//# sourceMappingURL=student-management-occupation-edit-detail.component.js.map