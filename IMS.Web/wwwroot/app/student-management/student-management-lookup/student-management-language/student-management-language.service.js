...
let LanguageManagementService = class LanguageManagementService {
    constructor(http) {
        this.http = http;
        this.LanguageManagementUrl = 'api/institutelanguagemanagement';
    }
    addInstituteLanguage(language) {
    ...
    getInstituteLanguageDetail(languageId) {
        return this.http.get(this.LanguageManagementUrl + '/' + languageId);
    }
    updateInstituteLanguage(language) {
        return this.http.put(this.LanguageManagementUrl, language);
    }
};
LanguageManagementService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], LanguageManagementService);
exports.LanguageManagementService = LanguageManagementService;
//# sourceMappingURL=student-management-language.service.js.map