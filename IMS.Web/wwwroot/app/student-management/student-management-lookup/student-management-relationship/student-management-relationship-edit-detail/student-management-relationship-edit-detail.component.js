...
let EditAndDetailRelationshipManagementComponent = class EditAndDetailRelationshipManagementComponent {
    constructor(relationshipManagementService, loaderService, router, snackBar) {
    ...
    updateInstituteRelationship(updateRelationship) {
        this.loaderService.toggleLoader(true);
        var updateData = {
...
EditAndDetailRelationshipManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.EditAndDetailRelationshipManagementComponent = EditAndDetailRelationshipManagementComponent;
//# sourceMappingURL=student-management-relationship-edit-detail.component.js.map