...
let EditAndDetailDisciplinaryStatusManagementComponent = class EditAndDetailDisciplinaryStatusManagementComponent {
    ...
    updateInstituteDisciplinaryStatus(updateDisciplinaryStatus) {
        this.loaderService.toggleLoader(true);
        var updateData = {
...
EditAndDetailDisciplinaryStatusManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.EditAndDetailDisciplinaryStatusManagementComponent = EditAndDetailDisciplinaryStatusManagementComponent;
//# sourceMappingURL=student-management-disciplinarystatus-edit.component.js.map