...
let ListDisciplinaryStatusManagementComponent = class ListDisciplinaryStatusManagementComponent {
    constructor(DisciplinaryStatusManagementService, loaderService, permissionService) {
        this.DisciplinaryStatusManagementService = DisciplinaryStatusManagementService;
        this.loaderService = loaderService;
        this.permissionService = permissionService;
        this.DisciplinaryStatuss = [];
    }
    ngOnInit() {
...
ListDisciplinaryStatusManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.ListDisciplinaryStatusManagementComponent = ListDisciplinaryStatusManagementComponent;
//# sourceMappingURL=student-management-disciplinarystatus-list.component.js.map