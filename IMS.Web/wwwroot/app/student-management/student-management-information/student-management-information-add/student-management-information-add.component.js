...
let AddStudentInformationManagementComponent = class AddStudentInformationManagementComponent {
    constructor(studentManagementService, loaderService, router, location, snackBar) {
        ...
        this.selectedTab = 0;
        this.initialData = {};
        this.addStudent = new student_management_information_model_1.AddStudentManagementAc();
...
], AddStudentInformationManagementComponent.prototype, "fileInput", void 0);
__decorate([
    core_1.ViewChild('gallery'),
    __metadata("design:type", core_1.ElementRef)
], AddStudentInformationManagementComponent.prototype, "gallery", void 0);
__decorate([
    core_1.ViewChild('document'),
    __metadata("design:type", core_1.ElementRef)
], AddStudentInformationManagementComponent.prototype, "document", void 0);
AddStudentInformationManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.AddStudentInformationManagementComponent = AddStudentInformationManagementComponent;
//# sourceMappingURL=student-management-information-add.component.js.map