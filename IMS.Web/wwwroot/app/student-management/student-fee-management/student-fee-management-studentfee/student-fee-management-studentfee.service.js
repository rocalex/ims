...
let StudentFeeManagementStudentFeeService = class StudentFeeManagementStudentFeeService {
    constructor(http) {
        this.http = http;
        this.StudentFeeManagementUrl = 'api/studentfeemanagement';
    }
    getStudentFee(studentId) {
        return this.http.get(this.StudentFeeManagementUrl + '/' + studentId);
    }
    updateStudentFee(studentFeeComponents, studentFeeId) {
...
StudentFeeManagementStudentFeeService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], StudentFeeManagementStudentFeeService);
exports.StudentFeeManagementStudentFeeService = StudentFeeManagementStudentFeeService;
//# sourceMappingURL=student-fee-management-studentfee.service.js.map