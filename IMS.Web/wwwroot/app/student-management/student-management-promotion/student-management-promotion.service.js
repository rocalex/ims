...
let StudentPromotionManagementService = class StudentPromotionManagementService {
    constructor(http) {
        this.http = http;
        this.StudentPromotionManagementUrl = 'api/studentpromotionmanagement';
    }
...
StudentPromotionManagementService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], StudentPromotionManagementService);
exports.StudentPromotionManagementService = StudentPromotionManagementService;
//# sourceMappingURL=student-management-promotion.service.js.map