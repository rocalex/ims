...
let StudentLeaveManagementService = class StudentLeaveManagementService {
    constructor(http) {
        this.http = http;
        this.StudentLeaveManagementUrl = 'api/leavemanagement/student';
    }
    addStudentLeave(leave) {
        return this.http.post(this.StudentLeaveManagementUrl, leave);
    }
    getStudentLeaves() {
        return this.http.get(this.StudentLeaveManagementUrl);
    }
    getStudentLeave(id) {
        return this.http.get(this.StudentLeaveManagementUrl + '/' + id);
    }
    updateStudentLeave(leave) {
        return this.http.put(this.StudentLeaveManagementUrl, leave);
    }
    getInitialData() {
        return this.http.get(this.StudentLeaveManagementUrl + '/initialdata');
    }
    getStudentAlreadyTakenLeaveCount(leave) {
...
StudentLeaveManagementService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], StudentLeaveManagementService);
exports.StudentLeaveManagementService = StudentLeaveManagementService;
//# sourceMappingURL=student-management-leave.service.js.map