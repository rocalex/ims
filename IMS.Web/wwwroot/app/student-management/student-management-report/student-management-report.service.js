...
let StudentManagementReportService = class StudentManagementReportService {
    constructor(http) {
        this.http = http;
    ...
    getHomework(staffId, classId, sectionId) {
        return this.http.get(this.HomeworkManagementUrl + '/' + staffId + '/' + classId + '/' + sectionId);
    }
};
StudentManagementReportService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], StudentManagementReportService);
exports.StudentManagementReportService = StudentManagementReportService;
//# sourceMappingURL=student-management-report.service.js.map