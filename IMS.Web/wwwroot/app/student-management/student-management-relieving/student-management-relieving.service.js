...
let StudentRelievingManagementService = class StudentRelievingManagementService {
    constructor(http) {
        this.http = http;
        this.StudentRelievingManagementUrl = 'api/studentrelievingmanagement';
    }
...
StudentRelievingManagementService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], StudentRelievingManagementService);
exports.StudentRelievingManagementService = StudentRelievingManagementService;
//# sourceMappingURL=student-management-relieving.service.js.map