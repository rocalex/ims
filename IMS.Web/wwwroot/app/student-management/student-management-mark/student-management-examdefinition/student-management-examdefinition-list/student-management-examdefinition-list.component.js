...
let ListStudentManagementExamDefinitionComponent = class ListStudentManagementExamDefinitionComponent {
    constructor(studentManagementExamDefinitionService, loaderService, permissionService) {
        this.studentManagementExamDefinitionService = studentManagementExamDefinitionService;
        this.loaderService = loaderService;
        this.permissionService = permissionService;
        this.examDefinitions = [];
    }
    ngOnInit() {
    ...
    isAllowed(type) {
        return this.permissionService.isAllowed(sidenav_model_1.UserGroupFeatureParentEnum.Student, sidenav_model_1.UserGroupFeatureChildEnum.StudentMarkExamDefinition, type);
    }
};
ListStudentManagementExamDefinitionComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.ListStudentManagementExamDefinitionComponent = ListStudentManagementExamDefinitionComponent;
//# sourceMappingURL=student-management-examdefinition-list.component.js.map