...
let RoomTypeEditComponent = class RoomTypeEditComponent {
    constructor(loaderService, permissionService, groupService, snackBar, router, activatedRoute) {
        ...
        this.errorMessage = '';
        this.addGroup = new lookup_model_1.RoomTypeModel();
...
RoomTypeEditComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.RoomTypeEditComponent = RoomTypeEditComponent;
