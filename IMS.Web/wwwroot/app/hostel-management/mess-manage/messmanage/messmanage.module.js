...
const messmanage_component_1 = require("./messmanage.component");
...
MessmanageModule = __decorate([
    core_1.NgModule({
        ...
        providers: [
            core_1.forwardRef(() => messmanage_service_1.MessManageService)
        ],
    })
], MessmanageModule);
exports.MessmanageModule = MessmanageModule;
//# sourceMappingURL=messmanage.module.js.map