...
let HostelManagementHostelService = class HostelManagementHostelService {
    constructor(http) {
        this.http = http;
        this.HostelManagementHostelUrl = 'api/hostel';
    }
    getHostelList() {
...
HostelManagementHostelService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], HostelManagementHostelService);
exports.HostelManagementHostelService = HostelManagementHostelService;
//# sourceMappingURL=hostel-management-hostel.service.js.map