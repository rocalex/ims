...
// Import models
const user_group_management_model_1 = require("../user-group-management.model");
let UserGroupManagementAddComponent = class UserGroupManagementAddComponent {
    constructor(userGroupManagementService, snackBar, router, loader) {
        this.userGroupManagementService = userGroupManagementService;
        this.snackBar = snackBar;
        this.router = router;
        this.loader = loader;
        this.userGroup = new user_group_management_model_1.AddUserGroup();
        this.errorMessage = '';
    }
    ngOnInit() { }
...
UserGroupManagementAddComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.UserGroupManagementAddComponent = UserGroupManagementAddComponent;
//# sourceMappingURL=user-group-management-add.component.js.map