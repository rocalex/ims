...
let TransportManagementAccidentService = class TransportManagementAccidentService {
    constructor(http) {
        this.http = http;
        this.AccidentManagementUrl = 'api/vehicleaccidentmanagement';
    }
...
TransportManagementAccidentService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], TransportManagementAccidentService);
exports.TransportManagementAccidentService = TransportManagementAccidentService;
//# sourceMappingURL=transport-management-accident.service.js.map