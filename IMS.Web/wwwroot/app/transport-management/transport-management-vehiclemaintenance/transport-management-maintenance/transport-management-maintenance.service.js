...
let TransportManagementMaintenanceService = class TransportManagementMaintenanceService {
    constructor(http) {
        this.http = http;
        this.MaintenanceManagementUrl = 'api/vehiclemaintenancemanagement';
    }
...
TransportManagementMaintenanceService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], TransportManagementMaintenanceService);
exports.TransportManagementMaintenanceService = TransportManagementMaintenanceService;
//# sourceMappingURL=transport-management-maintenance.service.js.map