...
let ListStaffLeaveManagementComponent = class ListStaffLeaveManagementComponent {
    constructor(staffLeaveManagementService, loaderService, snackBar, permissionService) {
    ...
    isAllowed(type) {
        return this.permissionService.isAllowed(sidenav_model_1.UserGroupFeatureParentEnum.Staff, sidenav_model_1.UserGroupFeatureChildEnum.StaffLeaveManagement, type);
    }
};
