...
let StaffDepartmentManagementService = class StaffDepartmentManagementService {
    constructor(http) {
        this.http = http;
        this.StaffDepartmentManagementUrl = 'api/departmentmanagement';
    }
...
StaffDepartmentManagementService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], StaffDepartmentManagementService);
exports.StaffDepartmentManagementService = StaffDepartmentManagementService;
//# sourceMappingURL=staff-management-department.service.js.map