...
let ListStaffDisciplinaryManagementComponent = class ListStaffDisciplinaryManagementComponent {
    constructor(staffDisciplinaryManagementService, loaderService, permissionService) {
    ...
    isAllowed(type) {
        return this.permissionService.isAllowed(sidenav_model_1.UserGroupFeatureParentEnum.Staff, sidenav_model_1.UserGroupFeatureChildEnum.Disciplinary, type);
    }
};
