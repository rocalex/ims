...
let AddStaffActivityManagementComponent = class AddStaffActivityManagementComponent {
    constructor(router, staffActivityManagementService, loaderService, snackBar) {
        this.router = router;
...
AddStaffActivityManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
...
exports.AddStaffActivityManagementComponent = AddStaffActivityManagementComponent;
//# sourceMappingURL=staff-management-activity-add.component.js.map