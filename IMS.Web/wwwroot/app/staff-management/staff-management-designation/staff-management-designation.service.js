...
let StaffDesignationManagementService = class StaffDesignationManagementService {
    constructor(http) {
        this.http = http;
        this.StaffDesignationManagementUrl = 'api/designationmanagement';
    }
    ...
    getDesignationDetail(designationId) {
...
StaffDesignationManagementService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], StaffDesignationManagementService);
exports.StaffDesignationManagementService = StaffDesignationManagementService;
//# sourceMappingURL=staff-management-designation.service.js.map