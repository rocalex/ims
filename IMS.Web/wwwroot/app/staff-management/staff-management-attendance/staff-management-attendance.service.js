...
let StaffAttendanceManagementService = class StaffAttendanceManagementService {
    constructor(http) {
        this.http = http;
        this.StaffAttendanceManagementUrl = 'api/staffattendancemanagement';
    }
    getIntialData() {
        return this.http.get(this.StaffAttendanceManagementUrl + '/intialdata');
    }
    addStaffAttendance(attendance) {
        return this.http.post(this.StaffAttendanceManagementUrl, attendance);
    }
    getStaffAttendance(StaffQuery) {
...
StaffAttendanceManagementService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], StaffAttendanceManagementService);
exports.StaffAttendanceManagementService = StaffAttendanceManagementService;
//# sourceMappingURL=staff-management-attendance.service.js.map