...
let AddStaffPlannerManagementComponent = class AddStaffPlannerManagementComponent {
    constructor(router, staffPlannerManagementService, loaderService, snackBar) {
        this.router = router;
    ...
    addStaffPlan() {
        if (this.plannerAttendeeList.length === 0) {
            ...
            this.loaderService.toggleLoader(true);
            this.staffPlannerManagementService.addStaffPlan(this.plan)
                .then(res => {
                let response = res.json();
...
AddStaffPlannerManagementComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
        templateUrl: 'staff-management-planner-add.html'
    }),
...
exports.AddStaffPlannerManagementComponent = AddStaffPlannerManagementComponent;
//# sourceMappingURL=staff-management-planner-add.component.js.map