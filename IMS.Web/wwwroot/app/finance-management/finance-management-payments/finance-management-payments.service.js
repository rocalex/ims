...
let FinanceManagementPaymentsService = class FinanceManagementPaymentsService {
    constructor(http) {
        this.http = http;
        this.FinanceManagementPaymentsUrl = 'api/financemanagement/payment';
    }
    ...
    getFinancePaymentById(financePaymentId) {
        return this.http.get(this.FinanceManagementPaymentsUrl + '/' + financePaymentId);
    }
    addNewFinancePayment(addedFinancePayment) {
        return this.http.post(this.FinanceManagementPaymentsUrl, addedFinancePayment);
    }
    updateFinancePayment(updatedFinancePayment) {
        return this.http.put(this.FinanceManagementPaymentsUrl, updatedFinancePayment);
    }
};
FinanceManagementPaymentsService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], FinanceManagementPaymentsService);
exports.FinanceManagementPaymentsService = FinanceManagementPaymentsService;
//# sourceMappingURL=finance-management-payments.service.js.map