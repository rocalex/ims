...
let FinanceManagementPaymentTypesService = class FinanceManagementPaymentTypesService {
    constructor(http) {
        this.http = http;
        this.FinanceManagementPaymentTypesUrl = 'api/financemanagement/paymenttypes';
    }
    getAllPaymentTypes() {
    ...
    addNewPaymentType(addedPaymentType) {
...
FinanceManagementPaymentTypesService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], FinanceManagementPaymentTypesService);
exports.FinanceManagementPaymentTypesService = FinanceManagementPaymentTypesService;
//# sourceMappingURL=finance-management-payment-types.service.js.map