...
let FinanceManagementReceiptService = class FinanceManagementReceiptService {
    constructor(http) {
        this.http = http;
        this.FinanceManagementReceiptUrl = 'api/financemanagement/receipt';
    }
    getFinanceReceiptsList() {
        return this.http.get(this.FinanceManagementReceiptUrl);
    }
    getFinanceReceiptById(financeReceiptId) {
        return this.http.get(this.FinanceManagementReceiptUrl + '/' + financeReceiptId);
    }
    addNewFinanceReceipt(addedFinanceReceipt) {
        return this.http.post(this.FinanceManagementReceiptUrl, addedFinanceReceipt);
    }
    updateFinanceReceipt(updatedFinanceReceipt) {
...
FinanceManagementReceiptService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_service_1.HttpService])
], FinanceManagementReceiptService);
exports.FinanceManagementReceiptService = FinanceManagementReceiptService;
//# sourceMappingURL=finance-management-receipt.service.js.map