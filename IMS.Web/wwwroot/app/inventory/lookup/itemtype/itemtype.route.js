...
const routes = [
    {
        path: 'inventory/lookup/itemtype', component: itemtype_component_1.ItemTypeComponent,
        children: [
            {
                path: '',
...
exports.ItemTypeRouting = router_1.RouterModule.forRoot(routes);
//# sourceMappingURL=itemtype.route.js.map