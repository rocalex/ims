...
const routes = [
    {
        path: 'inventory/lookup/uom', component: uom_component_1.UOMComponent,
        children: [
            {
                path: '',
...
exports.UOMRouting = router_1.RouterModule.forRoot(routes);
//# sourceMappingURL=uom.route.js.map